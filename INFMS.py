...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SectionMessage("INFMS is in progress - Please be patient")
    ...
    mesgdcrt.SuccessMessage("INFMS was created by SCARY")
...
def workernode(mode, cc, target, count, delay, max_threads):
    ...
    print("\n")
    mesgdcrt.SuccessMessage(" INFMS completed!")
    time.sleep(1.5)
    bann_text()
    sys.exit()
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage(" INFMS will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['SCARY',"-Other_Tools"]
...
description = """INFMS - Your Friendly Spammer Application


INFMS is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='INFMS is SCARY !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start INFMS with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start INFMS with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start INFMS with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update INFMS")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current INFMS contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current INFMS version")
